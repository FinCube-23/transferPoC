...
const FINCUBE_ABI = [
  ...
  },
  {
    ...
    inputs: [
      ...
      },
      {
        indexed: true,
        internalType: "bytes32",
        name: "receiver_reference_number",
        type: "bytes32",
      },
      {
        indexed: true,
  ...
  },
  {
    inputs: [
      ...
      { internalType: "bytes32", name: "orgReferenceKey", type: "bytes32" },
    ],
    name: "generateReferenceNumber",
    outputs: [
      { internalType: "bytes32", name: "referenceNumber", type: "bytes32" },
    ],
  ...
  },
  {
    inputs: [
      ...
      { internalType: "address", name: "_honkVerifier", type: "address" },
    ],
    name: "initialize",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  },
  {
    inputs: [
      ...
      { internalType: "bytes", name: "receiver_proof", type: "bytes" },
      {
        internalType: "bytes32[]",
        name: "receiver_publicInputs",
        type: "bytes32[]",
      },
    ],
    name: "safeTransfer",
...
export class ContractService {
  ...
  constructor(signer: ethers.Signer) {
    this.fincube = new ethers.Contract(
      contractAddresses.finCube,
      FINCUBE_ABI,
      signer
    );
  }
  ...
  async safeTransfer(
    ...
    try {
      ...
      if (nullifier.length !== 66 || !nullifier.startsWith("0x")) {
        ...
        throw new Error(
          "Nullifier must be a valid bytes32 value (0x + 64 hex chars)"
        );
      }
