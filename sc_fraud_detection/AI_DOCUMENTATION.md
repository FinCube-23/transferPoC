...
- Sender score ≥ 0.8 → "Transfer Blocked due to illegal activity"
- Receiver score ≥ 0.8 → "Receiver blocked due to illegal activity"
...
| 0.85 | 0.50 | ❌ "Transfer Blocked due to illegal activity" |
| 0.50 | 0.82 | ❌ "Receiver blocked due to illegal activity" |
| 0.80 | 0.80 | ❌ "Transfer Blocked due to illegal activity" |
